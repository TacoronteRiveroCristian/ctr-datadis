...
def run_quality_checks():
    ...
    checks = [
        (["poetry", "run", "black", "--check", "datadis_python/"], "Black format check"),
        (["poetry", "run", "isort", "--check-only", "datladis_python/"], "Import sorting check"),
    ...
    for command, description in checks:
        try:
            ...
            if "datladis_python" in command:
                command = [cmd.replace("datladis_python", "datadis_python") for cmd in command]
...
def run_test_validation():
    ...
    command = [
        "poetry", "run", "pytest",
        "tests/test_coverage_and_quality.py",
        "-v"
    ]
...
Ejemplos de uso:
  ...
  python run_tests.py --all                     # Todo lo anterior
    ...
    group.add_argument("--fast", action="store_true",
                      help="Ejecutar solo tests unitarios rápidos")
    group.add_argument("--full", action="store_true",
                      help="Ejecutar todos los tests")
    group.add_argument("--coverage", action="store_true",
                      help="Ejecutar tests con reporte de coverage")
    ...
    group.add_argument("--performance", action="store_true",
                      help="Ejecutar tests de performance")
    group.add_argument("--quality", action="store_true",
                      help="Ejecutar checks de calidad de código")
    group.add_argument("--validate", action="store_true",
                      help="Validar que los tests están bien escritos")
    group.add_argument("--all", action="store_true",
                      help="Ejecutar todos los tipos de tests y checks")
