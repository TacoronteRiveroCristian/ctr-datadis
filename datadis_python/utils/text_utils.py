...
def normalize_text(text: str) -> str:
    ...
    Examples:
        ...
        "EDISTRIBUCION"
        >>> normalize_text("EDISTRIBUCIÃ\x93N")  # Problema de doble codificación
        "EDISTRIBUCION"
        >>> normalize_text("Málaga")
        "Malaga"
        >>> normalize_text("CORUÑA")
        "CORUNA"
    """
...
def normalize_dict_strings(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    Args:
        data: Diccionario con datos a normalizar
        
    Returns:
        Diccionario con strings normalizados
    """
...
def normalize_list_strings(data: List[Any]) -> List[Any]:
    ...
    Args:
        data: Lista con datos a normalizar
        
    Returns:
        Lista con strings normalizados
    """
...
def normalize_api_response(response: Union[Dict[str, Any], List[Any]]) -> Union[Dict[str, Any], List[Any]]:
    """
    Normaliza respuesta de API completa (puede ser dict o list)
    
    Args:
        response: Respuesta de la API de Datadis
        
    Returns:
        Respuesta normalizada sin caracteres especiales
    """
