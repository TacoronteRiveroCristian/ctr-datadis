...
class ContractData(BaseModel):
    ...
    marketer: Optional[str] = Field(
        default=None, 
        description="Comercializadora (solo si es propietario del CUPS)"
    )
    tension: str = Field(description="Tensión")
    access_fare: str = Field(
        alias="accessFare", 
        description="Descripción tarifa de acceso"
    )
    ...
    contracted_power_kw: List[float] = Field(
        alias="contractedPowerkW",
        description="Potencias contratadas"
    )
    time_discrimination: Optional[str] = Field(
        default=None,
        alias="timeDiscrimination",
        description="Discriminación horaria"
    )
    ...
    code_fare: str = Field(
        alias="codeFare",
        description="Código de tarifa de acceso (códigos CNMC)"
    )
    ...
    section: Optional[str] = Field(
        default=None,
        description="Sección (autoconsumo)"
    )
    subsection: Optional[str] = Field(
        default=None,
        description="Subsección (autoconsumo)"
    )
    ...
    cau: Optional[str] = Field(
        default=None,
        description="CAU (autoconsumo)"
    )
