...
class DatadisClient:
    ...
    Uso:
        ...
        client.v1.get_supplies()  # API v1 (raw)
        client.v2.get_supplies()  # API v2 (tipado)
        
        # Métodos de conveniencia (usa v2 por defecto)
        client.get_supplies()  # Equivale a client.v2.get_supplies()
    """
    ...
    def get_consumption_summary(
        ...
        """
        return self.v2.get_consumption_summary(cups, distributor_code, date_from, date_to)
    ...
    def get_client_info(self) -> dict:
        ...
        return {
            ...
            "v1_authenticated": self._v1_client.token is not None if self._v1_client else False,
            "v2_authenticated": self._v2_client.token is not None if self._v2_client else False,
