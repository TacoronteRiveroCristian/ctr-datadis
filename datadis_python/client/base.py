...
from ..utils.constants import (
    DATADIS_BASE_URL, DATADIS_API_BASE, AUTH_ENDPOINTS,
    DEFAULT_TIMEOUT, MAX_RETRIES, TOKEN_EXPIRY_HOURS
)
...
class BaseDatadisClient(ABC):
    ...
    @abstractmethod
    def get_consumption(self, cups: str, distributor_code: str, date_from: str, date_to: str, **kwargs):
        """Obtiene datos de consumo"""
        pass
    
    @abstractmethod
    def get_max_power(self, cups: str, distributor_code: str, date_from: str, date_to: str, **kwargs):
